...
<p>Sistema de Micro serviço para envio de informações pessoais sobre o client, feito em NodeJS utilizando express</p>
...
<p>APOS ISSO A ROTA:<br><code>localhost:3000/api/whoami</code><br>ESTARA DISPONIVEIS PARA FAZER AS REQUISIÇÕES</p>
